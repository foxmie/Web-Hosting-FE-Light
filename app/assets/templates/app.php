...
<HTML lang="fr">
	<Head>
		...
		<Title>WEB Hosting FE Light</Title>
			...
			<div class="sidebar" data-color="blue" data-image="assets/img/sidebar-5.jpg">
				<div class="sidebar-wrapper">
					...
					<ul class="nav">
						...
						<li class="nav-item <?php if (!empty($_GET['service'])){ if ($_GET['service'] == 'bind'){ echo 'active'; } }?>">
							<a class="nav-link" href="?service=bind">
								<i class="nc-icon nc-planet"></i>
								<p>Gestion DNS</p>
							</a>
						</li>
						<li class="nav-item <?php if (!empty($_GET['service'])){ if ($_GET['service'] == 'sftp'){ echo 'active'; } }?>">
							<a class="nav-link" href="?service=sftp">
								<i class="nc-icon nc-app"></i>
								<p>Gestion SFTP</p>
							</a>
						</li>
						<li class="nav-item <?php if (!empty($_GET['service'])){ if ($_GET['service'] == 'mysql'){ echo 'active'; } }?>">
							<a class="nav-link" href="?service=mysql">
				...
				<nav class="navbar navbar-expand-lg ">
					<div class="container-fluid">
						<div class="navbar-wrapper">
							...
							<a class="navbar-brand" href=""> Web Hosting FE Light </a>
						</div>
